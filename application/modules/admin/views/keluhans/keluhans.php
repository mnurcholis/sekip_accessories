        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Kelola Keluhan Customer</h6>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    <h3 class="mb-0">Keluhan Customer</h3>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#packageList').DataTable({
                "ajax": "<?php echo site_url('admin/keluhans/keluhan_api?action=list'); ?>",
                "columns": [{
                        "data": "id"
                    },
                    {
