            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('admin/suppliers'); ?>">
                                <i class="fa fa-shopping-cart text-success"></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('admin/keluhans'); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('admin/laporans'); ?>">
