...
class Profile extends CI_Controller
{
    ...
    public function edit_email()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data->address = $provinsi . ', ' . $kabupaten . ', Kec.' . $kecamatan . ', ' . $kelurahan;
            ...
            $data->city_ro = !is_null($response->city_ro) ? $response->city_ro : '278';

            $flash_message = ($this->profile->update_alamat($data)) ? 'Alamat berhasil diperbarui' : 'Terjadi kesalahan';
